package com.brain.contact.web.rest;

import com.brain.contact.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/contact-kafka")
public class ContactKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ContactKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ContactKafkaResource(KafkaProperties kafkaProperties) {
